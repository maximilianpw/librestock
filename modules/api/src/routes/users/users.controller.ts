...
export class UsersController {
  ...
  async getUser(@Param('id') id: string, @Req() req: Request): Promise<UserResponseDto> {
  ...
  @ApiResponse({ status: 403, type: ErrorResponseDto })
  @ApiResponse({ status: 404, type: ErrorResponseDto })
  async unbanUser(@Param('id') id: string, @Req() req: Request): Promise<UserResponseDto> {
  ...
  @ApiResponse({ status: 403, type: ErrorResponseDto })
  @ApiResponse({ status: 404, type: ErrorResponseDto })
  async revokeSessions(@Param('id') id: string, @Req() req: Request): Promise<void> {
